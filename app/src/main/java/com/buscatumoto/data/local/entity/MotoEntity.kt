...
data class MotoEntity(
    @PrimaryKey
    @field:SerializedName("internalId") var internalId: Int, //Represents id for local DB
    @field:SerializedName("id") var id: String, //Represents bike's id from Server DB
